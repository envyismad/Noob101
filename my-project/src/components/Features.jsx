        ...
        <div className='my-24 md:px-14 px-4 max-w-screen-2xl mx-auto'>
            <div className='flex flex-col lg:flex-row justify-between items-start gap-10'>
                <div className='lg:w-1/2'>
                    ...
                    <p className='lg:w-1/2 text-base text-slate-500'>Discover a world of pampering and care for your furry friends, including expert boarding, fun-filled daycare, luxurious spa and grooming, and top-notch training services at our pet center.</p>
